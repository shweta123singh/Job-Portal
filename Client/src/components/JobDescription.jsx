  ...
  return (
    <div className='px-[6%] my-10'>
      ...
      <div className='my-4'>
        ...
        <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aspernatur fuga nulla qui molestias facilis? </span></h1>
        ...
        <h1 className='font-bold my-1'>Total Applicaants: <span className='pl-4 font-normal text-gray-800'>4</span></h1>
